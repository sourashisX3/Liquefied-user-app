...
android {
    namespace = "com.lecomapp.liquefied"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.lecomapp.liquefied"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
    ...
    productFlavors {
        create("dev") {
            ...
            buildConfigField("String", "BASE_URL", "\"http://10.102.226.33:8083/api/v1/\"")
            buildConfigField("String", "WS_URL", "\"ws://10.102.226.33:8083/api/v1/ws\"")
        }
        create("staging") {
            dimension = "environment"
